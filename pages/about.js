  ...
  return (
    ...
    <Row>
      <Col span={18} offset={3} style={{fontSize:"18px"}}>
        ...
        <p>
          Follow me maybe one day i can buy you coffee but I'll probably be busy
          so I'm not buying. come on take care. Despite everything, this boy
          loves you all.
        </p>

        <p>
          <strong>My favorite songs: </strong> Metallica -
        ...
        <p>
          ...
          Godfather, Papillon (1973), Pulp Fiction, The Hateful Eight, Sherlock
          Holmes (2009), The Lord of the Rings: The Two Towers, The Game (1997),
          No Country For Old Men, Lost Highway, Warrior, Undisputed 3, The
          Matrix, The Usual Suspects, 1408 (2007){" "}
        </p>
        <p>
          <strong>My favorite Tv Series:</strong>{" "}
